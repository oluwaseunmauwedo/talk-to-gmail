          ...
          if (item.type === "link" || item.type === "button") {
            return (
              ...
              <DropdownMenuPrimitive.Item asChild key={index}>
                {item.type === "link" ? (
                  <a
                    className="radix-highlighted:bg-neutral-200 radix-highlighted:text-neutral-950 dark:radix-highlighted:bg-neutral-800 dark:radix-highlighted:text-white flex w-full items-center justify-between gap-5 rounded-md p-2.5 text-neutral-700 focus:outline-none dark:text-neutral-300"
                    href={item.href || ""}
                  ...
                  <button
                    ...
                    className={cn(
                      "radix-highlighted:bg-neutral-200 radix-highlighted:text-neutral-950 dark:radix-highlighted:bg-neutral-800 dark:radix-highlighted:text-white flex w-full items-center justify-between gap-5 rounded-md p-2.5 text-neutral-700 focus:outline-none dark:text-neutral-300",
                      {
